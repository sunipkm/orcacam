...
typedef enum _DCAMPROPATTRIBUTE
{
    ...
    DCAMPROP_ATTR_ACTION =
        0x00000400, /* writing value takes related effect  */
...
typedef enum _DCAMPROPMODEVALUE
{
    ...
    DCAMPROP_MULTILINESENSOR_READOUTMODE__SYNCACCUMULATE =
        1, /* "SYNC ACCUMULATE"  */
    DCAMPROP_MULTILINESENSOR_READOUTMODE__SYNCAVERAGE =
        2, /* "SYNC AVERAGE"   */
...
typedef enum _DCAMIDPROP
{
    ...
    DCAM_IDPROP_EXPOSURETIME_RATIO = DCAM_IDPROP__RATIO | DCAM_IDPROP_EXPOSURETIME, /* reserved, R/W, real, "EXPOSURE TIME RATIO" */
    DCAM_IDPROP_CONTRASTGAIN_RATIO = DCAM_IDPROP__RATIO | DCAM_IDPROP_CONTRASTGAIN, /* reserved, R/W, real, "CONTRAST GAIN RATIO" */
